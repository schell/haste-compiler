...
prefetchByteArray3# a1 a2 = (GHC.Prim.prefetchByteArray3#) a1 a2
...
prefetchAddr3# a1 a2 = (GHC.Prim.prefetchAddr3#) a1 a2
{-# NOINLINE prefetchByteArray2# #-}
prefetchByteArray2# :: ByteArray# -> Int# -> ByteArray#
prefetchByteArray2# a1 a2 = (GHC.Prim.prefetchByteArray2#) a1 a2
...
prefetchAddr2# a1 a2 = (GHC.Prim.prefetchAddr2#) a1 a2
{-# NOINLINE prefetchByteArray1# #-}
prefetchByteArray1# :: ByteArray# -> Int# -> ByteArray#
prefetchByteArray1# a1 a2 = (GHC.Prim.prefetchByteArray1#) a1 a2
...
prefetchAddr1# a1 a2 = (GHC.Prim.prefetchAddr1#) a1 a2
{-# NOINLINE prefetchByteArray0# #-}
prefetchByteArray0# :: ByteArray# -> Int# -> ByteArray#
prefetchByteArray0# a1 a2 = (GHC.Prim.prefetchByteArray0#) a1 a2
...
prefetchAddr0# a1 a2 = (GHC.Prim.prefetchAddr0#) a1 a2
